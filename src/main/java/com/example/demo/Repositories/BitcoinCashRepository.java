...
@Repository
public class BitcoinCashRepository implements ICoinRepository {
    private List<Coin> coinList = new ArrayList<>();

    public BitcoinCashRepository() throws IOException {
        populate();
    }

    @Override
    public void populate() throws IOException {
        String webPage = "https://min-api.cryptocompare.com/data/v2/histoday?fsym=BCH&tsym=USD&limit=1000";
