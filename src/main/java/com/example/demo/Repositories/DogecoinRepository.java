...
public class DogecoinRepository implements ICoinRepository {
    ...
    public DogecoinRepository() throws IOException {
        populate();
    }

    @Override
    public void populate() throws IOException {
        String webPage = "https://min-api.cryptocompare.com/data/v2/histoday?fsym=DOGE&tsym=USD&limit=2000";
...
//            System.out.println(coin);
    ...
    public String styleJson(String json) {
        ...
        json = json.replaceAll("\"invert_divide\"", "");
        json = json.replaceAll("\\:\\,\\:\"\"", "");
        json = json.replaceAll("\\,\\}", "}");
