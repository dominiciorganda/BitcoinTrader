...
@Repository
public class BinanceCoinRepository implements ICoinRepository {
    private List<Coin> coinList = new ArrayList<>();

    public BinanceCoinRepository() throws IOException {
        populate();
    }

    @Override
    public void populate() throws IOException {
        String webPage = "https://min-api.cryptocompare.com/data/v2/histoday?fsym=BNB&tsym=USD&limit=1000";
