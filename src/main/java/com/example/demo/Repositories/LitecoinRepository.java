...
public class LitecoinRepository implements ICoinRepository {
    private List<Coin> coinList = new ArrayList<>();

    public LitecoinRepository() throws IOException {
        populate();
    }

    @Override
    public void populate() throws IOException {
        String webPage = "https://min-api.cryptocompare.com/data/v2/histoday?fsym=LTC&tsym=USD&limit=2000";
